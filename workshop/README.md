...
│  │                                                            │ │
│  │  ┌─────────────────────────────────────────────────────┐  │ │
│  │  │ EC2: g6e.4xlarge (NVIDIA L40S 48GB)                  │  │ │
│  │  │                                                      │  │ │
│  │  │  ┌────────────────────────────────────────────┐     │  │ │
│  │  │  │ Docker: isaac-lab-ready:latest              │     │  │ │
...
│  │  │   /data  : 500 GB gp3 (Checkpoints)                 │  │ │
│  │  │   /scratch: NVMe (Shader cache)                     │  │ │
│  │  └─────────────────────────────────────────────────────┘  │ │
│  │                          │                                 │ │
│  │                          ▼ (30분 자동 동기화)               │ │
│  │                 ┌─────────────────┐                        │ │
...
> ✅ **SUCCESS**
>
> **실전 기반**: 이 워크샵은 2026년 4월 실제 AWS 배포에서 겪은 **12가지 함정과 해결법**을 포함합니다. 공식 문서에 없는 실전 지식을 담았습니다.
